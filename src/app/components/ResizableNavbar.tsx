    ...
    <Navbar>
        ...
        <div className="relative z-30 flex items-center space-x-4">
          {socialLinks.map((social, index) => (
            <a
              ...
              className="relative z-20 text-neutral-300 hover:text-white transition-colors cursor-pointer"
              title={social.label}
            >
      ...
      <MobileNav className="dark">
        ...
        <MobileNavMenu isOpen={isOpen} onClose={() => setIsOpen(false)}>
          ...
          {/* Mobile Social Links */}
          <div className="relative z-30 flex items-center space-x-4 pt-4 border-t border-neutral-700">
            {socialLinks.map((social, index) => (
              <a
                key={index}
                href={social.href}
